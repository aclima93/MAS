...
s.t. constraint1: (sum{(i,j) in E} x[i,j]) - ( x[0,4] + x[4,8] ) >= 1;
s.t. constraint2: (sum{(i,j) in E} x[i,j]) - ( x[0,1] + x[1,8] ) >= 1;
s.t. constraint3: (sum{(i,j) in E} x[i,j]) - ( x[0,4] + x[1,2] + x[2,3] + x[3,1] + x[4,8] ) >= 1;
s.t. constraint4: (sum{(i,j) in E} x[i,j]) - ( x[0,1] + x[1,8] + x[4,5] + x[5,7] + x[7,4] ) >= 1;
s.t. constraint5: (sum{(i,j) in E} x[i,j]) - ( x[0,1] + x[1,8] + x[4,5] + x[5,6] + x[6,7] + x[7,4] ) >= 1;
