...
s.t. constraint1: (sum{(i,j) in E} x[i,j]) - ( x[0,1] + x[1,5] + x[5,12] ) >= 1;
s.t. constraint2: (sum{(i,j) in E} x[i,j]) - ( x[0,1] + x[1,2] + x[2,3] + x[3,4] + x[4,12] ) >= 1;
s.t. constraint3: (sum{(i,j) in E} x[i,j]) - ( x[0,1] + x[1,5] + x[4,9] + x[5,12] + x[9,10] + x[10,11] + x[11,4] ) >= 1;
s.t. constraint4: (sum{(i,j) in E} x[i,j]) - ( x[0,1] + x[1,5] + x[2,6] + x[5,12] + x[6,7] + x[7,8] + x[8,2] ) >= 1;
s.t. constraint5: (sum{(i,j) in E} x[i,j]) - ( x[0,1] + x[1,5] + x[2,6] + x[4,9] + x[5,12] + x[6,7] + x[7,8] + x[8,2] + x[9,10] + x[10,11] + x[11,4] ) >= 1;
